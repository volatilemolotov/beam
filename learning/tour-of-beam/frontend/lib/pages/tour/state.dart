...
// TODO(alexeyinkin): Read some config when backend's URL is emitted from
//  an infrastructure workflow.

const String kApiClientURL = 'https://router.34.160.22.119.nip.io';
...
class TourNotifier extends ChangeNotifier with PageStateMixin<void> {
  ...
  TourNotifier({
    ...
    contentTreeController.addListener(_onContentTreeControllerChanged);
  ...
  void _onContentTreeControllerChanged() {
    _onChanged();
  }
