...
/**
 * Object name: POSTEmailBillingDocfromBillRunType (POSTEmailBillingDocfromBillRunType). Related
 * objects:
 */
...
public class POSTEmailBillingDocfromBillRunType extends BaseObject {
  /** Name: resend (resend), Type: boolean. Options (custom, update, select): false, false, false */
  @Nullable
