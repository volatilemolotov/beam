...
/** Object name: DebitMemoItemType (DebitMemoItemType). Related objects: */
...
public class DebitMemoItemType extends BaseObject {
  ...
  /**
   * Name: taxationItems (taxationItems), Type: DebitMemoItemTypeTaxationItemsItem. Options (custom,
