...
/**
 * Object name: PaymentDebitMemoApplicationCreateRequestType
 * (PaymentDebitMemoApplicationCreateRequestType). Related objects:
 */
...
public class PaymentDebitMemoApplicationCreateRequestType extends BaseObject {
  ...
  /**
   * Name: items (items), Type: array|PaymentDebitMemoApplicationItemCreateRequestType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PaymentDebitMemoApplicationItemCreateRequestType")
