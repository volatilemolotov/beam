...
/** Object name: EventTrigger (EventTrigger). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "EventTrigger", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class EventTrigger extends BaseObject {
  ...
  /**
   * Name: baseObject (baseObject), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: condition (condition), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
