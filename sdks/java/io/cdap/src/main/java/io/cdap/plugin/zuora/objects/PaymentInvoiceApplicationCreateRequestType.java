...
/**
 * Object name: PaymentInvoiceApplicationCreateRequestType
 * (PaymentInvoiceApplicationCreateRequestType). Related objects:
 */
...
public class PaymentInvoiceApplicationCreateRequestType extends BaseObject {
  ...
  /**
   * Name: items (items), Type: array|PaymentInvoiceApplicationItemCreateRequestType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PaymentInvoiceApplicationItemCreateRequestType")
