...
/** Object name: JobResult (JobResult). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "JobResult", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class JobResult extends BaseObject {
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "JobResultCreditMemoNumbersItem")
  private List<JobResultCreditMemoNumbersItem> creditMemoNumbers;

  /**
   * Name: invoiceNumbers (invoiceNumbers), Type: array|JobResultInvoiceNumbersItem. Options
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "JobResultSubscriptionNumbersItem")
  private List<JobResultSubscriptionNumbersItem> subscriptionNumbers;

  /**
   * Name: subscriptions (subscriptions), Type: array|JobResultSubscriptionsItem. Options (custom,
