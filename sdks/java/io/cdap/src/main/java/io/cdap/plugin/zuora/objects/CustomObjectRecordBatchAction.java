...
/** Object name: CustomObjectRecordBatchAction (CustomObjectRecordBatchAction). Related objects: */
...
public class CustomObjectRecordBatchAction extends BaseObject {
  /**
   * Name: ids (ids), Type: array|CustomObjectRecordBatchActionIdsItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CustomObjectRecordBatchActionIdsItem")
  private List<CustomObjectRecordBatchActionIdsItem> ids;

  /**
   * Name: records (records), Type: CustomObjectRecordBatchActionRecordsItem. Options (custom,
