...
/** Object name: CreditMemoItemTypewithSuccess (CreditMemoItemTypewithSuccess). Related objects: */
...
public class CreditMemoItemTypewithSuccess extends BaseObject {
  ...
  /**
   * Name: creditTaxItems (creditTaxItems), Type: array|CMTaxItemType. Options (custom, update,
   ...
   * CreditMemoItemTypewithSuccessFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
