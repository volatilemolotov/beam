...
/** Object name: POSTPaymentMethodResponse (POSTPaymentMethodResponse). Related objects: */
...
public class POSTPaymentMethodResponse extends BaseObject {
  ...
  /**
   * Name: reasons (reasons), Type: array|POSTPaymentMethodResponseReasonsItem. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "POSTPaymentMethodResponseReasonsItem")
