...
/**
 * Object name: CreditMemoItemFromWriteOffInvoice (CreditMemoItemFromWriteOffInvoice). Related
 * objects:
 */
...
public class CreditMemoItemFromWriteOffInvoice extends BaseObject {
   ...
   * CreditMemoItemFromWriteOffInvoiceFinanceInformationItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
