...
/** Object name: CreateOrderRatePlanOverride (CreateOrderRatePlanOverride). Related objects: */
...
public class CreateOrderRatePlanOverride extends BaseObject {
  /**
   * Name: chargeOverrides (chargeOverrides), Type: array|CreateOrderChargeOverride. Options
