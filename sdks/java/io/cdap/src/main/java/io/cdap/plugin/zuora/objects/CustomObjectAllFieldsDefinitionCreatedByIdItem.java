...
/**
 * Object name: CustomObjectAllFieldsDefinitionCreatedByIdItem
 * (CustomObjectAllFieldsDefinitionCreatedByIdItem). Related objects:
 */
...
public class CustomObjectAllFieldsDefinitionCreatedByIdItem extends BaseObject {
  ...
  /** Name: origin (origin), Type: string. Options (custom, update, select): false, false, false */
  @Nullable
