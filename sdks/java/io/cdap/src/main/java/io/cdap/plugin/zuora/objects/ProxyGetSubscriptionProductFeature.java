...
/**
 * Object name: ProxyGetSubscriptionProductFeature (ProxyGetSubscriptionProductFeature). Related
 * objects:
 */
...
public class ProxyGetSubscriptionProductFeature extends BaseObject {
  ...
  /**
   * Name: FeatureId (FeatureId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
