...
/**
 * Object name: CreditMemoFromChargeDetailType (CreditMemoFromChargeDetailType). Related objects:
 */
...
public class CreditMemoFromChargeDetailType extends BaseObject {
   ...
   * CreditMemoFromChargeDetailTypeFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
