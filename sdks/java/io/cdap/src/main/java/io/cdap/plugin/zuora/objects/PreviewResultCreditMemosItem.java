...
/** Object name: PreviewResultCreditMemosItem (PreviewResultCreditMemosItem). Related objects: */
...
public class PreviewResultCreditMemosItem extends BaseObject {
  ...
  /**
   * Name: creditMemoItems (creditMemoItems), Type: array|InvoiceItemPreviewResult. Options (custom,
