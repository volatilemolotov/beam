...
/**
 * Object name: CommonUsageErrorResponseErrorItem (CommonUsageErrorResponseErrorItem). Related
 * objects:
 */
...
public class CommonUsageErrorResponseErrorItem extends BaseObject {
  /**
   * Name: errors (errors), Type: array|CommonUsageErrorResponseErrorItemErrorsItem. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CommonUsageErrorResponseErrorItemErrorsItem")
