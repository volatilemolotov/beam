...
/** Object name: ProxyGetRefundTransactionLog (ProxyGetRefundTransactionLog). Related objects: */
...
public class ProxyGetRefundTransactionLog extends BaseObject {
  ...
  /**
   * Name: RefundId (RefundId), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
