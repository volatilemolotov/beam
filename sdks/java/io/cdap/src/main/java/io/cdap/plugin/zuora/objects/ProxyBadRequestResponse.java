...
/** Object name: ProxyBadRequestResponse (ProxyBadRequestResponse). Related objects: */
...
public class ProxyBadRequestResponse extends BaseObject {
  /**
   * Name: Errors (Errors), Type: array|ProxyBadRequestResponseErrorsItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "ProxyBadRequestResponseErrorsItem")
