...
/** Object name: JournalRunType (JournalRunType). Related objects: */
...
public class JournalRunType extends BaseObject {
  ...
  /**
   * Name: segmentationRuleName (segmentationRuleName), Type: string. Options (custom, update,
  ...
  /**
   * Name: targetEndDate (targetEndDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: targetStartDate (targetStartDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: totalJournalEntryCount (totalJournalEntryCount), Type: integer. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: transactionTypes (transactionTypes), Type: array|JournalRunTransactionType. Options
