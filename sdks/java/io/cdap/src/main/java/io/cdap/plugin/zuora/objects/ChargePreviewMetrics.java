...
/** Object name: ChargePreviewMetrics (ChargePreviewMetrics). Related objects: */
...
public class ChargePreviewMetrics extends BaseObject {
  ...
  /**
   * Name: cmrr (cmrr), Type: ChargePreviewMetricsCmrrItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  @SerializedName("cmrr")
  ...
  /**
   * Name: tax (tax), Type: ChargePreviewMetricsTaxItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  @SerializedName("tax")
  ...
  /**
   * Name: tcb (tcb), Type: ChargePreviewMetricsTcbItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  @SerializedName("tcb")
  ...
  /**
   * Name: tcv (tcv), Type: ChargePreviewMetricsTcvItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  @SerializedName("tcv")
