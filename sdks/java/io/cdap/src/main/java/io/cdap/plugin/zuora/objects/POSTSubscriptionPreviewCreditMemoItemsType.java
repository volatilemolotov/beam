...
/**
 * Object name: POSTSubscriptionPreviewCreditMemoItemsType
 * (POSTSubscriptionPreviewCreditMemoItemsType). Related objects:
 */
...
public class POSTSubscriptionPreviewCreditMemoItemsType extends BaseObject {
  ...
  /**
   * Name: quantity (quantity), Type: integer. Options (custom, update, select): false, false, false
   */
  @Nullable
