...
/** Object name: SubscriptionTypeWithSuccess (SubscriptionTypeWithSuccess). Related objects: */
...
public class SubscriptionTypeWithSuccess extends BaseObject {
  ...
  /**
   * Name: contractedMrr (contractedMrr), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: invoiceOwnerAccountId (invoiceOwnerAccountId), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: invoiceOwnerAccountName (invoiceOwnerAccountName), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: invoiceOwnerAccountNumber (invoiceOwnerAccountNumber), Type: string. Options (custom,
  ...
  /**
   * Name: invoiceSeparately (invoiceSeparately), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: ratePlans (ratePlans), Type: array|SubscriptionRatePlanType. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalContractedValue (totalContractedValue), Type: number. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
