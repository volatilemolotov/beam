...
/**
 * Object name: CustomObjectDefinitionUpdateActionResponse
 * (CustomObjectDefinitionUpdateActionResponse). Related objects:
 */
...
public class CustomObjectDefinitionUpdateActionResponse extends BaseObject {
   ...
   * CustomObjectDefinitionUpdateActionResponseRelationshipItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
