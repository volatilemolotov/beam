...
/** Object name: POSTTaxationItemForCMType (POSTTaxationItemForCMType). Related objects: */
...
public class POSTTaxationItemForCMType extends BaseObject {
   ...
   * POSTTaxationItemForCMTypeFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
