...
/** Object name: AccountSummaryPaymentType (AccountSummaryPaymentType). Related objects: */
...
public class AccountSummaryPaymentType extends BaseObject {
  ...
  /**
   * Name: paidInvoices (paidInvoices), Type: array|AccountSummaryPaymentInvoiceType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "AccountSummaryPaymentInvoiceType")
  ...
  /**
   * Name: paymentType (paymentType), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
