...
/** Object name: POSTQuoteDocType (POSTQuoteDocType). Related objects: */
...
public class POSTQuoteDocType extends BaseObject {
  /**
   * Name: apiuser (apiuser), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: password (password), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: quoteId (quoteId), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: sandbox (sandbox), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: serverUrl (serverUrl), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: sessionId (sessionId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: templateId (templateId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: useSFDCLocale (useSFDCLocale), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: username (username), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: zquotesMajorVersion (zquotesMajorVersion), Type: string. Options (custom, update,
  ...
  /**
   * Name: zquotesMinorVersion (zquotesMinorVersion), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
