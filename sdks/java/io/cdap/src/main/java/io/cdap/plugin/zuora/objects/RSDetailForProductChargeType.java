...
/** Object name: RSDetailForProductChargeType (RSDetailForProductChargeType). Related objects: */
...
public class RSDetailForProductChargeType extends BaseObject {
  ...
  /**
   * Name: productChargeId (productChargeId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
