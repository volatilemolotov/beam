...
/** Object name: ProxyGetInvoiceItemAdjustment (ProxyGetInvoiceItemAdjustment). Related objects: */
...
public class ProxyGetInvoiceItemAdjustment extends BaseObject {
  ...
  /**
   * Name: AdjustmentNumber (AdjustmentNumber), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: CustomerName (CustomerName), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: CustomerNumber (CustomerNumber), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: InvoiceItemName (InvoiceItemName), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
