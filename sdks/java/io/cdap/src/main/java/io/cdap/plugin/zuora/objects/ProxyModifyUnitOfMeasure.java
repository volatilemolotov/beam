...
/** Object name: ProxyModifyUnitOfMeasure (ProxyModifyUnitOfMeasure). Related objects: */
...
public class ProxyModifyUnitOfMeasure extends BaseObject {
  ...
  /**
   * Name: DecimalPlaces (DecimalPlaces), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: DisplayedAs (DisplayedAs), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: RoundingMode (RoundingMode), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: UomName (UomName), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
