...
/**
 * Object name: POSTInvoiceCollectCreditMemosType (POSTInvoiceCollectCreditMemosType). Related
 * objects:
 */
...
public class POSTInvoiceCollectCreditMemosType extends BaseObject {
  ...
  /**
   * Name: memoAmount (memoAmount), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
