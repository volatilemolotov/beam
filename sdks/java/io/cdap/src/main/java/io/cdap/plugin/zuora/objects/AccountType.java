...
/** Object name: AccountType (AccountType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "AccountType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class AccountType extends BaseObject {
  /**
   * Name: billingAndPayment (billingAndPayment), Type: AccountTypeBillingAndPaymentItem. Options
  ...
  /**
   * Name: metrics (metrics), Type: AccountTypeMetricsItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: taxInfo (taxInfo), Type: AccountTypeTaxInfoItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
