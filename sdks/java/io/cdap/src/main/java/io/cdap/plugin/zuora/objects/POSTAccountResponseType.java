...
/** Object name: POSTAccountResponseType (POSTAccountResponseType). Related objects: */
...
public class POSTAccountResponseType extends BaseObject {
  ...
  /**
   * Name: billToContactId (billToContactId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: soldToContactId (soldToContactId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: totalContractedValue (totalContractedValue), Type: string. Options (custom, update,
