...
/**
 * Object name: AccountSummaryTypeBasicInfoDefaultPaymentMethodItem
 * (AccountSummaryTypeBasicInfoDefaultPaymentMethodItem). Related objects:
 */
...
public class AccountSummaryTypeBasicInfoDefaultPaymentMethodItem extends BaseObject {
  /**
   * Name: creditCardExpirationMonth (creditCardExpirationMonth), Type: string. Options (custom,
  ...
  /**
   * Name: creditCardExpirationYear (creditCardExpirationYear), Type: string. Options (custom,
   * update, select): false, false, false
   */
  @Nullable
