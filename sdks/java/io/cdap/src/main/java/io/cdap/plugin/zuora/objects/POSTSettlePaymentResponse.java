...
/** Object name: POSTSettlePaymentResponse (POSTSettlePaymentResponse). Related objects: */
...
public class POSTSettlePaymentResponse extends BaseObject {
   ...
   * POSTSettlePaymentResponseFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
