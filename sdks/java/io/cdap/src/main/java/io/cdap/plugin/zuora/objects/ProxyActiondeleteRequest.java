...
/** Object name: ProxyActiondeleteRequest (ProxyActiondeleteRequest). Related objects: */
...
public class ProxyActiondeleteRequest extends BaseObject {
  /**
   * Name: ids (ids), Type: array|ProxyActiondeleteRequestIdsItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  @SerializedName("ids")
  @ObjectFieldDefinition(
      ...
      NestedClass = "ProxyActiondeleteRequestIdsItem")
