...
/** Object name: RatePlanUpdateForEvergreen (RatePlanUpdateForEvergreen). Related objects: */
...
public class RatePlanUpdateForEvergreen extends BaseObject {
  /**
   * Name: chargeUpdates (chargeUpdates), Type: array|ChargeUpdateForEvergreen. Options (custom,
