...
/** Object name: PUTVerifyPaymentMethodType (PUTVerifyPaymentMethodType). Related objects: */
...
public class PUTVerifyPaymentMethodType extends BaseObject {
  ...
  /**
   * Name: paymentGatewayName (paymentGatewayName), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
