...
/** Object name: ARPaymentTypewithSuccess (ARPaymentTypewithSuccess). Related objects: */
...
public class ARPaymentTypewithSuccess extends BaseObject {
  ...
  /**
   * Name: creditBalanceAmount (creditBalanceAmount), Type: number. Options (custom, update,
   ...
   * ARPaymentTypewithSuccessFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: secondPaymentReferenceId (secondPaymentReferenceId), Type: string. Options (custom,
   * update, select): false, false, false
   */
  @Nullable
