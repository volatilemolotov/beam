...
/** Object name: ProxyActionupdateRequest (ProxyActionupdateRequest). Related objects: */
...
public class ProxyActionupdateRequest extends BaseObject {
  /**
   * Name: objects (objects), Type: array|ZObject_update. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
