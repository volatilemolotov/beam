...
/**
 * Object name: CommonUsageImportsErrorResponseErrorItemErrorsItem
 * (CommonUsageImportsErrorResponseErrorItemErrorsItem). Related objects:
 */
...
public class CommonUsageImportsErrorResponseErrorItemErrorsItem extends BaseObject {
  ...
  /**
   * Name: rejectedValue (rejectedValue), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
