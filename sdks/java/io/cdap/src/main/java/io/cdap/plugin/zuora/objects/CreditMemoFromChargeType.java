...
/** Object name: CreditMemoFromChargeType (CreditMemoFromChargeType). Related objects: */
...
public class CreditMemoFromChargeType extends BaseObject {
  ...
  /**
   * Name: charges (charges), Type: array|CreditMemoFromChargeDetailType. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CreditMemoFromChargeDetailType")
