...
/**
 * Object name: ProxyGetPaymentMethodTransactionLog (ProxyGetPaymentMethodTransactionLog). Related
 * objects:
 */
...
public class ProxyGetPaymentMethodTransactionLog extends BaseObject {
  ...
  /**
   * Name: PaymentMethodType (PaymentMethodType), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
