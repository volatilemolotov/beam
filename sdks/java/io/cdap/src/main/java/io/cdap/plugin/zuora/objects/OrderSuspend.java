...
/** Object name: OrderSuspend (OrderSuspend). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "OrderSuspend", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class OrderSuspend extends BaseObject {
  ...
  /**
   * Name: suspendPeriods (suspendPeriods), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
