...
/** Object name: DebitMemoFromChargeType (DebitMemoFromChargeType). Related objects: */
...
public class DebitMemoFromChargeType extends BaseObject {
  ...
  /**
   * Name: charges (charges), Type: array|DebitMemoFromChargeDetailType. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "DebitMemoFromChargeDetailType")
