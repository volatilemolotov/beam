...
/** Object name: CreatePaymentMethodACH (CreatePaymentMethodACH). Related objects: */
...
public class CreatePaymentMethodACH extends BaseObject {
  ...
  /**
   * Name: bankABACode (bankABACode), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: bankAccountName (bankAccountName), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: bankAccountNumber (bankAccountNumber), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: bankAccountType (bankAccountType), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
