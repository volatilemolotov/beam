...
/** Object name: PaymentRunSummaryTotalValues (PaymentRunSummaryTotalValues). Related objects: */
...
public class PaymentRunSummaryTotalValues extends BaseObject {
  /**
   * Name: totalValueOfCreditBalance (totalValueOfCreditBalance), Type: string. Options (custom,
  ...
  /**
   * Name: totalValueOfCreditMemos (totalValueOfCreditMemos), Type: string. Options (custom, update,
  ...
  /**
   * Name: totalValueOfDebitMemos (totalValueOfDebitMemos), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalValueOfErrors (totalValueOfErrors), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalValueOfInvoices (totalValueOfInvoices), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalValueOfPayments (totalValueOfPayments), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalValueOfReceivables (totalValueOfReceivables), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalValueOfUnappliedPayments (totalValueOfUnappliedPayments), Type: integer. Options
  ...
  /**
   * Name: totalValueOfUnprocessedInvoices (totalValueOfUnprocessedInvoices), Type: string. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  public void addFields() {
    ...
    addCustomField(
        "totalValueOfUnprocessedDebitMemos", totalValueOfUnprocessedDebitMemos, String.class);
    addCustomField(
        "totalValueOfUnprocessedInvoices", totalValueOfUnprocessedInvoices, String.class);
    addCustomField(
        "totalValueOfUnprocessedReceivables", totalValueOfUnprocessedReceivables, String.class);
  }
}
