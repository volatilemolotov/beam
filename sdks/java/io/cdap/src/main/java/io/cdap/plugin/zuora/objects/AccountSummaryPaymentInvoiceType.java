...
/**
 * Object name: AccountSummaryPaymentInvoiceType (AccountSummaryPaymentInvoiceType). Related
 * objects:
 */
...
public class AccountSummaryPaymentInvoiceType extends BaseObject {
  /**
   * Name: appliedPaymentAmount (appliedPaymentAmount), Type: string. Options (custom, update,
