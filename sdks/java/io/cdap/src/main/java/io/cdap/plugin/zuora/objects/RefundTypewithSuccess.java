...
/** Object name: RefundTypewithSuccess (RefundTypewithSuccess). Related objects: */
...
public class RefundTypewithSuccess extends BaseObject {
   ...
   * RefundTypewithSuccessFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
