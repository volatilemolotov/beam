...
/** Object name: AccountSummaryType (AccountSummaryType). Related objects: */
...
public class AccountSummaryType extends BaseObject {
  /**
   * Name: invoices (invoices), Type: array|AccountSummaryInvoiceType. Options (custom, update,
  ...
  /**
   * Name: payments (payments), Type: array|AccountSummaryPaymentType. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: subscriptions (subscriptions), Type: array|AccountSummarySubscriptionType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "AccountSummarySubscriptionType")
  ...
  /**
   * Name: taxInfo (taxInfo), Type: AccountSummaryTypeTaxInfoItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: usage (usage), Type: array|AccountSummaryUsageType. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
