...
/**
 * Object name: PostCustomObjectDefinitionRequest (PostCustomObjectDefinitionRequest). Related
 * objects:
 */
...
public class PostCustomObjectDefinitionRequest extends BaseObject {
  ...
  /**
   * Name: properties (properties), Type: PostCustomObjectDefinitionRequestPropertiesItem. Options
  ...
  /**
   * Name: relationships (relationships), Type:
   * array|PostCustomObjectDefinitionRequestRelationshipsItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PostCustomObjectDefinitionRequestRelationshipsItem")
  private List<PostCustomObjectDefinitionRequestRelationshipsItem> relationships;

  /**
   * Name: required (required), Type: array|PostCustomObjectDefinitionRequestRequiredItem. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "PostCustomObjectDefinitionRequestRequiredItem")
