...
/** Object name: ProxyCreateInvoiceAdjustment (ProxyCreateInvoiceAdjustment). Related objects: */
...
public class ProxyCreateInvoiceAdjustment extends BaseObject {
  ...
  /**
   * Name: ImpactAmount (ImpactAmount), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
