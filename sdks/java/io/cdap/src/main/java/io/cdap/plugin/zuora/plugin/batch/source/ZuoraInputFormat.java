...
public class ZuoraInputFormat<K, V> extends InputFormat<K, V> {
   ...
   *
   * <p>Minimal unit for the parallelization is an object.
   *
   * <p>In the single-object mode would be always only one split, as REST API does not provide
   * information on amount of records returned.
   *
   * <p>In multi-object mode, amount of splits would be the same as amount of the objects selected
   * by the user.
   *
