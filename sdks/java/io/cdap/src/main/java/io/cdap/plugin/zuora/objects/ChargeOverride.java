...
/** Object name: ChargeOverride (ChargeOverride). Related objects: */
...
public class ChargeOverride extends BaseObject {
  /**
   * Name: billing (billing), Type: ChargeOverrideBillingItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: pricing (pricing), Type: ChargeOverridePricingItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
