...
/**
 * Object name: ProxyModifyProductRatePlanCharge (ProxyModifyProductRatePlanCharge). Related
 * objects:
 */
...
public class ProxyModifyProductRatePlanCharge extends BaseObject {
  ...
  /**
   * Name: DefaultQuantity (DefaultQuantity), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: DeferredRevenueAccount (DeferredRevenueAccount), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: LegacyRevenueReporting (LegacyRevenueReporting), Type: boolean. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: MaxQuantity (MaxQuantity), Type: number. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: MinQuantity (MinQuantity), Type: number. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: NumberOfPeriod (NumberOfPeriod), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: PriceIncreaseOption (PriceIncreaseOption), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: RecognizedRevenueAccount (RecognizedRevenueAccount), Type: string. Options (custom,
   * update, select): false, false, false
   */
  @Nullable
