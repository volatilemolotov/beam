...
/** Object name: OrderForEvergreen (OrderForEvergreen). Related objects: */
...
public class OrderForEvergreen extends BaseObject {
  ...
  /**
   * Name: subscriptions (subscriptions), Type: array|OrderForEvergreenSubscriptionsItem.. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "OrderForEvergreenSubscriptionsItem")
