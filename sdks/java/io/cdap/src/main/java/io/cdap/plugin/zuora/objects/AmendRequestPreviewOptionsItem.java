...
/**
 * Object name: AmendRequestPreviewOptionsItem (AmendRequestPreviewOptionsItem). Related objects:
 */
...
public class AmendRequestPreviewOptionsItem extends BaseObject {
  /**
   * Name: EnablePreviewMode (EnablePreviewMode), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: PreviewThroughTermEnd (PreviewThroughTermEnd), Type: boolean. Options (custom, update,
