...
/** Object name: ProxyActiongenerateRequest (ProxyActiongenerateRequest). Related objects: */
...
public class ProxyActiongenerateRequest extends BaseObject {
  /**
   * Name: objects (objects), Type: array|ZObject. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
