...
/** Object name: ProxyGetRefundInvoicePayment (ProxyGetRefundInvoicePayment). Related objects: */
...
public class ProxyGetRefundInvoicePayment extends BaseObject {
  ...
  /**
   * Name: InvoicePaymentId (InvoicePaymentId), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
