...
/**
 * Object name: PreviewOrderCreateSubscription (PreviewOrderCreateSubscription). Related objects:
 */
...
public class PreviewOrderCreateSubscription extends BaseObject {
   ...
   * PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccountItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PreviewOrderRatePlanOverride")
  ...
  /**
   * Name: terms (terms), Type: PreviewOrderCreateSubscriptionTermsItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
