...
/** Object name: DebitMemoItemTypewithSuccess (DebitMemoItemTypewithSuccess). Related objects: */
...
public class DebitMemoItemTypewithSuccess extends BaseObject {
  ...
  /**
   * Name: beAppliedAmount (beAppliedAmount), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
   ...
   * DebitMemoItemTypewithSuccessFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: skuName (skuName), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: sourceItemId (sourceItemId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: sourceItemType (sourceItemType), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: taxItems (taxItems), Type: array|DMTaxItemType. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
