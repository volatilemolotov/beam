...
/** Object name: Invoice (Invoice). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "Invoice", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class Invoice extends BaseObject {
  ...
  /**
   * Name: BillRunId (BillRunId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: RegenerateInvoicePDF (RegenerateInvoicePDF), Type: boolean. Options (custom, update,
