...
/** Object name: ProxyActionqueryMoreResponse (ProxyActionqueryMoreResponse). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "ProxyActionqueryMoreResponse",
    RequiredArguments = {"queryMoreRequest"},
...
public class ProxyActionqueryMoreResponse extends BaseObject {
  ...
  /**
   * Name: queryLocator (queryLocator), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: records (records), Type: array|ZObject. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
