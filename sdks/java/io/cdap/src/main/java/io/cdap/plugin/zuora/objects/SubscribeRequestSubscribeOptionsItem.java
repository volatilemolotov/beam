...
/**
 * Object name: SubscribeRequestSubscribeOptionsItem (SubscribeRequestSubscribeOptionsItem). Related
 * objects:
 */
...
public class SubscribeRequestSubscribeOptionsItem extends BaseObject {
  ...
  /**
   * Name: ElectronicPaymentOptions (ElectronicPaymentOptions), Type:
   * SubscribeRequestSubscribeOptionsItemElectronicPaymentOptionsItem. Options (custom, update,
  ...
  /**
   * Name: ExternalPaymentOptions (ExternalPaymentOptions), Type:
   * SubscribeRequestSubscribeOptionsItemExternalPaymentOptionsItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: GenerateInvoice (GenerateInvoice), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: ProcessPayments (ProcessPayments), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: SubscribeInvoiceProcessingOptions (SubscribeInvoiceProcessingOptions), Type:
   * SubscribeRequestSubscribeOptionsItemSubscribeInvoiceProcessingOptionsItem. Options (custom,
  ...
  public void addFields() {
    ...
    addCustomField(
        "subscribeInvoiceProcessingOptions", subscribeInvoiceProcessingOptions, String.class);
  }
}
