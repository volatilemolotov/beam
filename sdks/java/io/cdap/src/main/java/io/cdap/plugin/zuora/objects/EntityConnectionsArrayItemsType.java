...
/**
 * Object name: EntityConnectionsArrayItemsType (EntityConnectionsArrayItemsType). Related objects:
 */
...
public class EntityConnectionsArrayItemsType extends BaseObject {
  ...
  /**
   * Name: sourceEntityId (sourceEntityId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: targetEntityId (targetEntityId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
