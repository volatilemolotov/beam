...
/** Object name: PreviewOrderRatePlanUpdate (PreviewOrderRatePlanUpdate). Related objects: */
...
public class PreviewOrderRatePlanUpdate extends BaseObject {
  /**
   * Name: chargeUpdates (chargeUpdates), Type: array|PreviewOrderChargeUpdate. Options (custom,
