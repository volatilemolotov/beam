...
/** Object name: OrderActionForEvergreen (OrderActionForEvergreen). Related objects: */
...
public class OrderActionForEvergreen extends BaseObject {
  /**
   * Name: orderMetrics (orderMetrics), Type: array|OrderMetricsForEvergreen. Options (custom,
