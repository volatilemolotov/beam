...
/** Object name: PUTRSTermType (PUTRSTermType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "PUTRSTermType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class PUTRSTermType extends BaseObject {
  /**
   * Name: distributionType (distributionType), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: eventType (eventType), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: eventTypeSystemId (eventTypeSystemId), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: recognitionEnd (recognitionEnd), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: recognitionStart (recognitionStart), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
