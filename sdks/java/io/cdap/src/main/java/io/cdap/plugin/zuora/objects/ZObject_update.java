...
/** Object name: ZObject_update (ZObject_update). Related objects: */
...
public class ZObject_update extends BaseObject {
  ...
  /**
   * Name: fieldsToNull (fieldsToNull), Type: array|ZObject_updateFieldsToNullItem. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "ZObject_updateFieldsToNullItem")
