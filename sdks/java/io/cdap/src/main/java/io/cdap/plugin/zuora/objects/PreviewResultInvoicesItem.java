...
/** Object name: PreviewResultInvoicesItem (PreviewResultInvoicesItem). Related objects: */
...
public class PreviewResultInvoicesItem extends BaseObject {
  ...
  /**
   * Name: invoiceItems (invoiceItems), Type: array|InvoiceItemPreviewResult. Options (custom,
