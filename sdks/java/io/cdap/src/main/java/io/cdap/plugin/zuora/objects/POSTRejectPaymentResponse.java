...
/** Object name: POSTRejectPaymentResponse (POSTRejectPaymentResponse). Related objects: */
...
public class POSTRejectPaymentResponse extends BaseObject {
   ...
   * POSTRejectPaymentResponseFinanceInformationItem.. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
