...
/** Object name: POSTJournalEntryItemType (POSTJournalEntryItemType). Related objects: */
...
public class POSTJournalEntryItemType extends BaseObject {
  /**
   * Name: accountingCodeName (accountingCodeName), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: accountingCodeType (accountingCodeType), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: homeCurrencyAmount (homeCurrencyAmount), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
