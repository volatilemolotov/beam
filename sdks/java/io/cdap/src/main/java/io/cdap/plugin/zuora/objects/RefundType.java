...
/** Object name: RefundType (RefundType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "RefundType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class RefundType extends BaseObject {
  ...
  /**
   * Name: financeInformation (financeInformation), Type: RefundTypeFinanceInformationItem. Options
