...
/** Object name: CreditMemoItemBreakdown (CreditMemoItemBreakdown). Related objects: */
...
public class CreditMemoItemBreakdown extends BaseObject {
  ...
  /**
   * Name: applyToChargeNumber (applyToChargeNumber), Type: string. Options (custom, update,
  ...
  /**
   * Name: breakdownDetails (breakdownDetails), Type: array|BreakdownDetail. Options (custom,
  ...
  /**
   * Name: isNegativePrice (isNegativePrice), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
