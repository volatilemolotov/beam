...
/** Object name: ProxyGetBillRun (ProxyGetBillRun). Related objects: */
...
public class ProxyGetBillRun extends BaseObject {
  ...
  /**
   * Name: AutoEmail (AutoEmail), Type: boolean. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: AutoRenewal (AutoRenewal), Type: boolean. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: BillRunNumber (BillRunNumber), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: ExecutedDate (ExecutedDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: InvoicesEmailed (InvoicesEmailed), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: LastEmailSentTime (LastEmailSentTime), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: NoEmailForZeroAmountInvoice (NoEmailForZeroAmountInvoice), Type: boolean. Options
  ...
  /**
   * Name: NumberOfAccounts (NumberOfAccounts), Type: integer. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
