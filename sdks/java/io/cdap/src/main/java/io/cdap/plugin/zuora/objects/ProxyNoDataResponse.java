...
/** Object name: ProxyNoDataResponse (ProxyNoDataResponse). Related objects: */
...
public class ProxyNoDataResponse extends BaseObject {
  ...
  /**
   * Name: records (records), Type: array|ProxyNoDataResponseRecordsItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "ProxyNoDataResponseRecordsItem")
