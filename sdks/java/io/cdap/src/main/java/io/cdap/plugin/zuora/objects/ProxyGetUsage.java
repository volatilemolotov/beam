...
/** Object name: ProxyGetUsage (ProxyGetUsage). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "ProxyGetUsage", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class ProxyGetUsage extends BaseObject {
  ...
  /**
   * Name: RbeStatus (RbeStatus), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
