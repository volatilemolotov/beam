...
/**
 * Object name: OrderForEvergreenSubscriptionsItem (OrderForEvergreenSubscriptionsItem). Related
 * objects:
 */
...
public class OrderForEvergreenSubscriptionsItem extends BaseObject {
  /**
   * Name: baseVersion (baseVersion), Type: integer. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: newVersion (newVersion), Type: integer. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: orderActions (orderActions), Type: array|OrderActionForEvergreen. Options (custom,
