...
/**
 * Object name: POSTSubscriptionPreviewResponseTypeCreditMemoItem
 * (POSTSubscriptionPreviewResponseTypeCreditMemoItem). Related objects:
 */
...
public class POSTSubscriptionPreviewResponseTypeCreditMemoItem extends BaseObject {
  ...
  /**
   * Name: creditMemoItems (creditMemoItems), Type:
   * array|POSTSubscriptionPreviewCreditMemoItemsType. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "POSTSubscriptionPreviewCreditMemoItemsType")
