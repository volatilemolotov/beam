...
/** Object name: UpdateTask (UpdateTask). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "UpdateTask", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class UpdateTask extends BaseObject {
  ...
  /**
   * Name: tags (tags), Type: array|UpdateTaskTagsItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  @SerializedName("tags")
