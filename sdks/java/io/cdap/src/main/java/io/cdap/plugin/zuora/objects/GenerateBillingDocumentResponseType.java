...
/**
 * Object name: GenerateBillingDocumentResponseType (GenerateBillingDocumentResponseType). Related
 * objects:
 */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "GenerateBillingDocument",
    RequiredPostArguments = {"body", "id"},
...
public class GenerateBillingDocumentResponseType extends BaseObject {
  /**
   * Name: creditMemos (creditMemos), Type: array|CreditMemoResponseType. Options (custom, update,
  ...
  /**
   * Name: invoices (invoices), Type: array|InvoiceResponseType. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
