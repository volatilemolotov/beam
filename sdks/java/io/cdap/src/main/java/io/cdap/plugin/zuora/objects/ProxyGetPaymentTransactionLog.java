...
/** Object name: ProxyGetPaymentTransactionLog (ProxyGetPaymentTransactionLog). Related objects: */
...
public class ProxyGetPaymentTransactionLog extends BaseObject {
  /**
   * Name: AVSResponseCode (AVSResponseCode), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: BatchId (BatchId), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: CVVResponseCode (CVVResponseCode), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: GatewayReasonCode (GatewayReasonCode), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: GatewayReasonCodeDescription (GatewayReasonCodeDescription), Type: string. Options
  ...
  /**
   * Name: GatewayTransactionType (GatewayTransactionType), Type: string. Options (custom, update,
  ...
  /**
   * Name: RequestString (RequestString), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: ResponseString (ResponseString), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: TransactionDate (TransactionDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
