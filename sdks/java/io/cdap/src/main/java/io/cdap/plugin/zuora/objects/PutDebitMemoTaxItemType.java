...
/** Object name: PutDebitMemoTaxItemType (PutDebitMemoTaxItemType). Related objects: */
...
public class PutDebitMemoTaxItemType extends BaseObject {
   ...
   * PutDebitMemoTaxItemTypeFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
