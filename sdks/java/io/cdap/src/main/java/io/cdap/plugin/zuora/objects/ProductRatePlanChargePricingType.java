...
/**
 * Object name: ProductRatePlanChargePricingType (ProductRatePlanChargePricingType). Related
 * objects:
 */
...
public class ProductRatePlanChargePricingType extends BaseObject {
  ...
  /**
   * Name: discountAmount (discountAmount), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: discountPercentage (discountPercentage), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: overagePrice (overagePrice), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /** Name: price (price), Type: string. Options (custom, update, select): false, false, false */
  @Nullable
  ...
  /**
   * Name: tiers (tiers), Type: array|ProductRatePlanChargePricingTierType. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "ProductRatePlanChargePricingTierType")
