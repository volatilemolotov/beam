...
/** Object name: PreviewOptions (PreviewOptions). Related objects: */
...
public class PreviewOptions extends BaseObject {
  /**
   * Name: previewThruType (previewThruType), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: previewTypes (previewTypes), Type: array|PreviewOptionsPreviewTypesItem. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PreviewOptionsPreviewTypesItem")
  private List<PreviewOptionsPreviewTypesItem> previewTypes;

  /**
   * Name: specificPreviewThruDate (specificPreviewThruDate), Type: string. Options (custom, update,
