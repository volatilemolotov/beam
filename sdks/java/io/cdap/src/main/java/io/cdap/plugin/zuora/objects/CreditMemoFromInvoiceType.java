...
/** Object name: CreditMemoFromInvoiceType (CreditMemoFromInvoiceType). Related objects: */
...
public class CreditMemoFromInvoiceType extends BaseObject {
  /**
   * Name: autoApplyToInvoiceUponPosting (autoApplyToInvoiceUponPosting), Type: boolean. Options
  ...
  /**
   * Name: items (items), Type: array|CreditMemoItemFromInvoiceItemType. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CreditMemoItemFromInvoiceItemType")
  ...
  /**
   * Name: taxAutoCalculation (taxAutoCalculation), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
