...
/** Object name: UnapplyPaymentType (UnapplyPaymentType). Related objects: */
...
public class UnapplyPaymentType extends BaseObject {
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PaymentDebitMemoApplicationUnapplyRequestType")
  ...
  /**
   * Name: invoices (invoices), Type: array|PaymentInvoiceApplicationUnapplyRequestType. Options
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "PaymentInvoiceApplicationUnapplyRequestType")
