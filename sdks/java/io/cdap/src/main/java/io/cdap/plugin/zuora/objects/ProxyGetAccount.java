...
/** Object name: ProxyGetAccount (ProxyGetAccount). Related objects: */
...
public class ProxyGetAccount extends BaseObject {
  ...
  /**
   * Name: CreditBalance (CreditBalance), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: TotalInvoiceBalance (TotalInvoiceBalance), Type: number. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
