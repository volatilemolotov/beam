...
/** Object name: PreviewOrderRatePlanOverride (PreviewOrderRatePlanOverride). Related objects: */
...
public class PreviewOrderRatePlanOverride extends BaseObject {
  /**
   * Name: chargeOverrides (chargeOverrides), Type: array|PreviewOrderChargeOverride. Options
