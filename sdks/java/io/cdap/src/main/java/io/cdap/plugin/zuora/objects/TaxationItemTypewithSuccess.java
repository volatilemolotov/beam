...
/** Object name: TaxationItemTypewithSuccess (TaxationItemTypewithSuccess). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "Taxation",
    RequiredPostArguments = {"debitMemoId", "body"},
...
public class TaxationItemTypewithSuccess extends BaseObject {
   ...
   * TaxationItemTypewithSuccessFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: memoItemId (memoItemId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: sourceTaxItemId (sourceTaxItemId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
