...
/**
 * Object name: POSTSubscriptionCancellationType (POSTSubscriptionCancellationType). Related
 * objects:
 */
...
public class POSTSubscriptionCancellationType extends BaseObject {
  ...
  /**
   * Name: cancellationEffectiveDate (cancellationEffectiveDate), Type: string. Options (custom,
  ...
  /**
   * Name: cancellationPolicy (cancellationPolicy), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
