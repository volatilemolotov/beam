...
/** Object name: BillingDocumentsResponseType (BillingDocumentsResponseType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "BillingDocuments",
    responseRootElement = "billingDocuments",
    RequiredArguments = {"accountId"},
...
public class BillingDocumentsResponseType extends BaseObject {
  ...
  /**
   * Name: documentNumber (documentNumber), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
