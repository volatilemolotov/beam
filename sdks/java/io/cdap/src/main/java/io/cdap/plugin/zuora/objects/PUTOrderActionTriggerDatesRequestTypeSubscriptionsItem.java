...
/**
 * Object name: PUTOrderActionTriggerDatesRequestTypeSubscriptionsItem
 * (PUTOrderActionTriggerDatesRequestTypeSubscriptionsItem). Related objects:
 */
...
public class PUTOrderActionTriggerDatesRequestTypeSubscriptionsItem extends BaseObject {
  /**
   * Name: orderActions (orderActions), Type:
   * array|PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItem. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItem")
