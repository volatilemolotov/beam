...
/** Object name: ProductRatePlanChargeType (ProductRatePlanChargeType). Related objects: */
...
public class ProductRatePlanChargeType extends BaseObject {
  ...
  /**
   * Name: defaultQuantity (defaultQuantity), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
   ...
   * ProductRatePlanChargeTypeFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: includedUnits (includedUnits), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: maxQuantity (maxQuantity), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: minQuantity (minQuantity), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: prepayPeriods (prepayPeriods), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: priceIncreasePercentage (priceIncreasePercentage), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: pricing (pricing), Type: array|ProductRatePlanChargePricingType. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "ProductRatePlanChargePricingType")
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "ProductRatePlanChargeTypePricingSummaryItem")
  private List<ProductRatePlanChargeTypePricingSummaryItem> pricingSummary;

  /**
   * Name: productDiscountApplyDetails (productDiscountApplyDetails), Type:
   * array|ProductDiscountApplyDetailsType. Options (custom, update, select): false, false, false
   */
  @Nullable
  @SerializedName("productDiscountApplyDetails")
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "ProductDiscountApplyDetailsType")
  ...
  /**
   * Name: taxable (taxable), Type: boolean. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: useTenantDefaultForPriceChange (useTenantDefaultForPriceChange), Type: boolean. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  public void addFields() {
    ...
    addCustomField(
        "useDiscountSpecificAccountingCode", useDiscountSpecificAccountingCode, Boolean.class);
