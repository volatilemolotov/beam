...
/** Object name: UnapplyCreditMemoType (UnapplyCreditMemoType). Related objects: */
...
public class UnapplyCreditMemoType extends BaseObject {
  /**
   * Name: debitMemos (debitMemos), Type: array|CreditMemoUnapplyDebitMemoRequestType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CreditMemoUnapplyDebitMemoRequestType")
  ...
  /**
   * Name: invoices (invoices), Type: array|CreditMemoUnapplyInvoiceRequestType. Options (custom,
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "CreditMemoUnapplyInvoiceRequestType")
