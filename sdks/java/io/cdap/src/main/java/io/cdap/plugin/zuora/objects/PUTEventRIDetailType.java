...
/** Object name: PUTEventRIDetailType (PUTEventRIDetailType). Related objects: */
...
public class PUTEventRIDetailType extends BaseObject {
  /**
   * Name: revenueItems (revenueItems), Type: array|EventRevenueItemType. Options (custom, update,
