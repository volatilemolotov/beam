...
/** Object name: PaymentType (PaymentType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "PaymentType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class PaymentType extends BaseObject {
  ...
  /**
   * Name: gatewayTransactionNumber (gatewayTransactionNumber), Type: string. Options (custom,
  ...
  /**
   * Name: paidInvoices (paidInvoices), Type: array|PaidInvoicesType. Options (custom, update,
