...
/**
 * Object name: JournalEntryDetailTypeWithoutSuccess (JournalEntryDetailTypeWithoutSuccess). Related
 * objects:
 */
...
public class JournalEntryDetailTypeWithoutSuccess extends BaseObject {
  ...
  /**
   * Name: aggregateCurrency (aggregateCurrency), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: homeCurrency (homeCurrency), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: journalEntryDate (journalEntryDate), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: journalEntryItems (journalEntryItems), Type: array|JournalEntryItemType. Options (custom,
  ...
  /**
   * Name: segments (segments), Type: array|JournalEntrySegmentType. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: timePeriodEnd (timePeriodEnd), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: timePeriodStart (timePeriodStart), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: transactionType (transactionType), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: transferDateTime (transferDateTime), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: transferredBy (transferredBy), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
