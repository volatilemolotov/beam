...
/** Object name: RefundCreditMemoType (RefundCreditMemoType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "RefundCreditMemo",
    RequiredPostArguments = {"body", "creditmemoId"},
...
public class RefundCreditMemoType extends BaseObject {
   ...
   * RefundCreditMemoTypeFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
