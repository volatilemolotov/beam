...
/** Object name: ProxyGetInvoiceSplitItem (ProxyGetInvoiceSplitItem). Related objects: */
...
public class ProxyGetInvoiceSplitItem extends BaseObject {
  ...
  /**
   * Name: InvoiceSplitId (InvoiceSplitId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: SplitPercentage (SplitPercentage), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
