...
/** Object name: POSTJournalRunType (POSTJournalRunType). Related objects: */
...
public class POSTJournalRunType extends BaseObject {
  ...
  /**
   * Name: transactionTypes (transactionTypes), Type: array|POSTJournalRunTransactionType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "POSTJournalRunTransactionType")
