...
/** Object name: SubscribeResult (SubscribeResult). Related objects: */
...
public class SubscribeResult extends BaseObject {
  ...
  /**
   * Name: InvoiceData (InvoiceData), Type: array|InvoiceData. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: InvoiceResult (InvoiceResult), Type: SubscribeResultInvoiceResultItem. Options (custom,
  ...
  /**
   * Name: TotalMrr (TotalMrr), Type: number. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: TotalTcv (TotalTcv), Type: number. Options (custom, update, select): false, false, false
   */
  @Nullable
