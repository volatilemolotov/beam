...
/** Object name: Term (Term). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "Term", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class Term extends BaseObject {
  ...
  /**
   * Name: isEvergreen (isEvergreen), Type: boolean. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
