...
/** Object name: UsageImport (UsageImport). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "UsageImport", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class UsageImport extends BaseObject {
  ...
  /**
   * Name: errorCount (errorCount), Type: number. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: importedCount (importedCount), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: processEnd (processEnd), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: processStart (processStart), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: totalCount (totalCount), Type: number. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
