...
/** Object name: BreakdownDetail (BreakdownDetail). Related objects: */
...
public class BreakdownDetail extends BaseObject {
  ...
  /**
   * Name: generatedReason (generatedReason), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: orderActionId (orderActionId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: orderItemId (orderItemId), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
