...
/**
 * Object name: SubscribeRequestSubscriptionDataSubscription
 * (SubscribeRequestSubscriptionDataSubscription). Related objects:
 */
...
public class SubscribeRequestSubscriptionDataSubscription extends BaseObject {
  ...
  /**
   * Name: AncestorAccountId (AncestorAccountId), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: CancelledDate (CancelledDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: ContractAcceptanceDate (ContractAcceptanceDate), Type: string. Options (custom, update,
  ...
  /**
   * Name: CreatorAccountId (CreatorAccountId), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: CreatorInvoiceOwnerId (CreatorInvoiceOwnerId), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: InitialTermPeriodType (InitialTermPeriodType), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: InvoiceOwnerId (InvoiceOwnerId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: IsInvoiceSeparate (IsInvoiceSeparate), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: OriginalCreatedDate (OriginalCreatedDate), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: PreviousSubscriptionId (PreviousSubscriptionId), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: SubscriptionEndDate (SubscriptionEndDate), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
