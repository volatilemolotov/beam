...
/** Object name: Amendment (Amendment). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "Amendment", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class Amendment extends BaseObject {
  ...
  /**
   * Name: RatePlanData (RatePlanData), Type: AmendmentRatePlanDataItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
