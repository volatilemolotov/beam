...
public class ObjectHelper {
            ...
            .map(
                x -> {
                  try {
                    ...
                    String name =
                        (objectFieldDefinition.FieldName().isEmpty())
   ...
   * @return new schema
   */
  public static Schema alterSchema(
      String internalObjectName, Schema oldSchema, List<Pair<String, Schema.Type>> newFields) {
