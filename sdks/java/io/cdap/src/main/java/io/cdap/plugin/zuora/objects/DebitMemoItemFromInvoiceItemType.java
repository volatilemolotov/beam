...
/**
 * Object name: DebitMemoItemFromInvoiceItemType (DebitMemoItemFromInvoiceItemType). Related
 * objects:
 */
...
public class DebitMemoItemFromInvoiceItemType extends BaseObject {
   ...
   * DebitMemoItemFromInvoiceItemTypeFinanceInformationItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: taxItems (taxItems), Type: array|DebitMemoTaxItemFromInvoiceTaxItemType. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "DebitMemoTaxItemFromInvoiceTaxItemType")
