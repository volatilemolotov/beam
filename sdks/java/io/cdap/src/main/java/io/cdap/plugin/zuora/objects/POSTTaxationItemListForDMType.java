...
/** Object name: POSTTaxationItemListForDMType (POSTTaxationItemListForDMType). Related objects: */
...
public class POSTTaxationItemListForDMType extends BaseObject {
  /**
   * Name: taxationItems (taxationItems), Type: array|POSTTaxationItemForDMType. Options (custom,
