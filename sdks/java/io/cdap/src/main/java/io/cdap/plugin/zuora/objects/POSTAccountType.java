...
/** Object name: POSTAccountType (POSTAccountType). Related objects: */
...
public class POSTAccountType extends BaseObject {
   ...
   * array|POSTAccountTypeAdditionalEmailAddressesItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "POSTAccountTypeAdditionalEmailAddressesItem")
  ...
  /**
   * Name: hpmCreditCardPaymentMethodId (hpmCreditCardPaymentMethodId), Type: string. Options
  ...
  /**
   * Name: soldToSameAsBillTo (soldToSameAsBillTo), Type: boolean. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: taxInfo (taxInfo), Type: POSTAccountTypeTaxInfoItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
