...
/**
 * Object name: CreateSubscriptionForEvergreen (CreateSubscriptionForEvergreen). Related objects:
 */
...
public class CreateSubscriptionForEvergreen extends BaseObject {
   ...
   * CreateSubscriptionForEvergreenNewSubscriptionOwnerAccountItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "RatePlanOverrideForEvergreen")
  ...
  /**
   * Name: terms (terms), Type: CreateSubscriptionForEvergreenTermsItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
