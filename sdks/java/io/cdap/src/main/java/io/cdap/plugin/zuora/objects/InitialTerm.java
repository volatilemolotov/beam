...
/** Object name: InitialTerm (InitialTerm). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "InitialTerm", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class InitialTerm extends BaseObject {
  /** Name: period (period), Type: integer. Options (custom, update, select): false, false, false */
  @Nullable
  ...
  /**
   * Name: periodType (periodType), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
