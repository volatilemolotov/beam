...
/**
 * Object name: POSTPublicNotificationDefinitionRequestCalloutItem
 * (POSTPublicNotificationDefinitionRequestCalloutItem). Related objects:
 */
...
public class POSTPublicNotificationDefinitionRequestCalloutItem extends BaseObject {
  ...
  /**
   * Name: calloutBaseurl (calloutBaseurl), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: calloutRetry (calloutRetry), Type: boolean. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: httpMethod (httpMethod), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: requiredAuth (requiredAuth), Type: boolean. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
