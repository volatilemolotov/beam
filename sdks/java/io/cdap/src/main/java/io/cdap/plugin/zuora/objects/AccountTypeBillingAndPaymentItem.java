...
/**
 * Object name: AccountTypeBillingAndPaymentItem (AccountTypeBillingAndPaymentItem). Related
 * objects:
 */
...
public class AccountTypeBillingAndPaymentItem extends BaseObject {
   ...
   * array|AccountTypeBillingAndPaymentItemAdditionalEmailAddressesItem. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "AccountTypeBillingAndPaymentItemAdditionalEmailAddressesItem")
  private List<AccountTypeBillingAndPaymentItemAdditionalEmailAddressesItem>
