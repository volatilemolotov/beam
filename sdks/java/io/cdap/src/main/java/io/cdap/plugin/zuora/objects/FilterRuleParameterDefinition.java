...
/** Object name: FilterRuleParameterDefinition (FilterRuleParameterDefinition). Related objects: */
...
public class FilterRuleParameterDefinition extends BaseObject {
  ...
  /**
   * Name: options (options), Type: array|FilterRuleParameterDefinitionOptionsItem. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "FilterRuleParameterDefinitionOptionsItem")
  private List<FilterRuleParameterDefinitionOptionsItem> options;

  /**
   * Name: valueType (valueType), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
