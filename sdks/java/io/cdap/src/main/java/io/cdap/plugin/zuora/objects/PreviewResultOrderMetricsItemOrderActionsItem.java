...
/**
 * Object name: PreviewResultOrderMetricsItemOrderActionsItem
 * (PreviewResultOrderMetricsItemOrderActionsItem). Related objects:
 */
...
public class PreviewResultOrderMetricsItemOrderActionsItem extends BaseObject {
  ...
  /**
   * Name: sequence (sequence), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
