...
/** Object name: BillToContactPostOrder (BillToContactPostOrder). Related objects: */
...
public class BillToContactPostOrder extends BaseObject {
  ...
  /**
   * Name: contactDescription (contactDescription), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
