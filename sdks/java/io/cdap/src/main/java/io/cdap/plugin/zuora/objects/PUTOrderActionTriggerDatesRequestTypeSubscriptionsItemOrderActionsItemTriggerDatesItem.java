 ...
 * (PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItemTriggerDatesItem). Related
 * objects:
 */
...
public class PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItemTriggerDatesItem
    extends BaseObject {
