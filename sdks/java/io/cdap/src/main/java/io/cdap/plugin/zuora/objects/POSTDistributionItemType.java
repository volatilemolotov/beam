...
/** Object name: POSTDistributionItemType (POSTDistributionItemType). Related objects: */
...
public class POSTDistributionItemType extends BaseObject {
  ...
  /**
   * Name: newAmount (newAmount), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
