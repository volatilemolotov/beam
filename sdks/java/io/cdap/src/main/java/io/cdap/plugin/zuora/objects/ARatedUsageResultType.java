...
/** Object name: ARatedUsageResultType (ARatedUsageResultType). Related objects: */
...
public class ARatedUsageResultType extends BaseObject {
  ...
  /**
   * Name: ratedResultId (ratedResultId), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: usageId (usageId), Type: string. Options (custom, update, select): false, false, false
   */
  @Nullable
