...
/**
 * Object name: CreditMemoItemFromInvoiceItemType (CreditMemoItemFromInvoiceItemType). Related
 * objects:
 */
...
public class CreditMemoItemFromInvoiceItemType extends BaseObject {
   ...
   * CreditMemoItemFromInvoiceItemTypeFinanceInformationItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: taxItems (taxItems), Type: array|CreditMemoTaxItemFromInvoiceTaxItemType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CreditMemoTaxItemFromInvoiceTaxItemType")
