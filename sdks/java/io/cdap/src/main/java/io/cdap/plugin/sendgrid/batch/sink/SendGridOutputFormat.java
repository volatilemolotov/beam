...
/**
 * An OutputFormat that sends the output of a Hadoop job to the SendGrid record writer, also it
 * defines the output committer.
 */
public class SendGridOutputFormat extends OutputFormat<NullWritable, SendGridMail> {
  @Override
  public RecordWriter<NullWritable, SendGridMail> getRecordWriter(
