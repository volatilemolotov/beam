...
/** Object name: AmendRequest (AmendRequest). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "AmendRequest", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class AmendRequest extends BaseObject {
  /**
   * Name: AmendOptions (AmendOptions), Type: AmendRequestAmendOptionsItem. Options (custom, update,
  ...
  /**
   * Name: Amendments (Amendments), Type: array|Amendment. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: PreviewOptions (PreviewOptions), Type: AmendRequestPreviewOptionsItem. Options (custom,
