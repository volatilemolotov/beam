...
/** Object name: AccountTypeMetricsItem (AccountTypeMetricsItem). Related objects: */
...
public class AccountTypeMetricsItem extends BaseObject {
  ...
  /**
   * Name: contractedMrr (contractedMrr), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: creditBalance (creditBalance), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: totalDebitMemoBalance (totalDebitMemoBalance), Type: string. Options (custom, update,
  ...
  /**
   * Name: totalInvoiceBalance (totalInvoiceBalance), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: unappliedCreditMemoAmount (unappliedCreditMemoAmount), Type: string. Options (custom,
  ...
  /**
   * Name: unappliedPaymentAmount (unappliedPaymentAmount), Type: string. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
