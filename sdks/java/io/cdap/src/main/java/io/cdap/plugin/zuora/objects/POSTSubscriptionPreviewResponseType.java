...
/**
 * Object name: POSTSubscriptionPreviewResponseType (POSTSubscriptionPreviewResponseType). Related
 * objects:
 */
...
public class POSTSubscriptionPreviewResponseType extends BaseObject {
  ...
  /**
   * Name: chargeMetrics (chargeMetrics), Type:
   * POSTSubscriptionPreviewResponseTypeChargeMetricsItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: creditMemo (creditMemo), Type: POSTSubscriptionPreviewResponseTypeCreditMemoItem. Options
  ...
  /**
   * Name: invoice (invoice), Type: POSTSubscriptionPreviewResponseTypeInvoiceItem. Options (custom,
  ...
  /**
   * Name: invoiceItems (invoiceItems), Type: array|POSTSubscriptionPreviewInvoiceItemsType. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "POSTSubscriptionPreviewInvoiceItemsType")
