...
/** Object name: ProxyGetCommunicationProfile (ProxyGetCommunicationProfile). Related objects: */
...
public class ProxyGetCommunicationProfile extends BaseObject {
  ...
  /**
   * Name: ProfileName (ProfileName), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
