...
/** Object name: DebitMemoFromInvoiceType (DebitMemoFromInvoiceType). Related objects: */
...
public class DebitMemoFromInvoiceType extends BaseObject {
  ...
  /**
   * Name: items (items), Type: array|DebitMemoItemFromInvoiceItemType. Options (custom, update,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "DebitMemoItemFromInvoiceItemType")
