...
/** Object name: WorkflowResponse (WorkflowResponse). Related objects: */
...
public class WorkflowResponse extends BaseObject {
  /**
   * Name: cpuTime (cpuTime), Type: number. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: finishedAt (finishedAt), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: messages (messages), Type: WorkflowResponseMessagesItem. Options (custom, update,
  ...
  /**
   * Name: originalWorkflowId (originalWorkflowId), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: runTime (runTime), Type: number. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: tasks (tasks), Type: WorkflowResponseTasksItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
