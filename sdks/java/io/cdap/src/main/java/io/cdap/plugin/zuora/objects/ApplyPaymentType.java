...
/** Object name: ApplyPaymentType (ApplyPaymentType). Related objects: */
...
public class ApplyPaymentType extends BaseObject {
  /**
   * Name: debitMemos (debitMemos), Type: array|PaymentDebitMemoApplicationApplyRequestType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PaymentDebitMemoApplicationApplyRequestType")
  ...
  /**
   * Name: invoices (invoices), Type: array|PaymentInvoiceApplicationApplyRequestType. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      FieldType = Schema.Type.ARRAY,
      NestedClass = "PaymentInvoiceApplicationApplyRequestType")
