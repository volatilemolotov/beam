...
/** Object name: PUTDebitMemoItemType (PUTDebitMemoItemType). Related objects: */
...
public class PUTDebitMemoItemType extends BaseObject {
   ...
   * PUTDebitMemoItemTypeFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: taxItems (taxItems), Type: array|PutDebitMemoTaxItemType. Options (custom, update,
