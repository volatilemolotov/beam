...
/** Object name: SubscriptionRatedResult (SubscriptionRatedResult). Related objects: */
...
public class SubscriptionRatedResult extends BaseObject {
  /**
   * Name: chargeRatedResults (chargeRatedResults), Type: array|ChargeRatedResult. Options (custom,
