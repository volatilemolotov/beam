...
/** Object name: CreateSubscriptionTermsItem (CreateSubscriptionTermsItem). Related objects: */
...
public class CreateSubscriptionTermsItem extends BaseObject {
  ...
  /**
   * Name: initialTerm (initialTerm), Type: CreateSubscriptionTermsItemInitialTermItem. Options
