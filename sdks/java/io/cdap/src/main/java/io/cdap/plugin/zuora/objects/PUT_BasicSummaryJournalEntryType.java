...
/**
 * Object name: PUT_BasicSummaryJournalEntryType (PUT_BasicSummaryJournalEntryType). Related
 * objects:
 */
...
public class PUT_BasicSummaryJournalEntryType extends BaseObject {
  /**
   * Name: journalEntryItems (journalEntryItems), Type: array|PUTJournalEntryItemType. Options
