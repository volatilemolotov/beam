...
/** Object name: BillingPreviewRunResponse (BillingPreviewRunResponse). Related objects: */
...
public class BillingPreviewRunResponse extends BaseObject {
  ...
  /**
   * Name: resultFileUrl (resultFileUrl), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: runNumber (runNumber), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: succeededAccounts (succeededAccounts), Type: integer. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: totalAccounts (totalAccounts), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
