...
/** Object name: OrderAction (OrderAction). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "OrderAction", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class OrderAction extends BaseObject {
  /**
   * Name: orderItems (orderItems), Type: array|OrderItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: orderMetrics (orderMetrics), Type: array|OrderMetric. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: triggerDates (triggerDates), Type: array|TriggerDate. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
