...
/**
 * Object name: SubscribeRequestPaymentMethodItemGatewayOptionDataItem
 * (SubscribeRequestPaymentMethodItemGatewayOptionDataItem). Related objects:
 */
...
public class SubscribeRequestPaymentMethodItemGatewayOptionDataItem extends BaseObject {
  /**
   * Name: GatewayOption (GatewayOption), Type: array|GatewayOption. Options (custom, update,
