...
/** Object name: PUTSrpAddType (PUTSrpAddType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "PUTSrpAddType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class PUTSrpAddType extends BaseObject {
  /**
   * Name: chargeOverrides (chargeOverrides), Type: array|PUTScAddType. Options (custom, update,
