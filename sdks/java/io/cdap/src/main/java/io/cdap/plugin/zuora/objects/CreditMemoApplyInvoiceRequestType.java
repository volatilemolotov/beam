...
/**
 * Object name: CreditMemoApplyInvoiceRequestType (CreditMemoApplyInvoiceRequestType). Related
 * objects:
 */
...
public class CreditMemoApplyInvoiceRequestType extends BaseObject {
  ...
  /**
   * Name: items (items), Type: array|CreditMemoApplyInvoiceItemRequestType. Options (custom,
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "CreditMemoApplyInvoiceItemRequestType")
