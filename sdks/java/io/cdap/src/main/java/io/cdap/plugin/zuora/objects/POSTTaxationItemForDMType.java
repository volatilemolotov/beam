...
/** Object name: POSTTaxationItemForDMType (POSTTaxationItemForDMType). Related objects: */
...
public class POSTTaxationItemForDMType extends BaseObject {
   ...
   * POSTTaxationItemForDMTypeFinanceInformationItem. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
