...
/** Object name: POSTJournalEntryType (POSTJournalEntryType). Related objects: */
...
public class POSTJournalEntryType extends BaseObject {
  ...
  /**
   * Name: journalEntryItems (journalEntryItems), Type: array|POSTJournalEntryItemType. Options
  ...
  /**
   * Name: segments (segments), Type: array|POSTJournalEntrySegmentType. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
