...
/** Object name: ProxyGetImport (ProxyGetImport). Related objects: */
...
public class ProxyGetImport extends BaseObject {
  ...
  /**
   * Name: ImportType (ImportType), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: ImportedCount (ImportedCount), Type: integer. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /** Name: Md5 (Md5), Type: string. Options (custom, update, select): false, false, false */
  @Nullable
  @SerializedName("md5")
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String md5;
  ...
  /**
   * Name: OriginalResourceUrl (OriginalResourceUrl), Type: string. Options (custom, update,
  ...
  /**
   * Name: ResultResourceUrl (ResultResourceUrl), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: TotalCount (TotalCount), Type: integer. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
