...
/** Object name: PUTCreditMemoItemType (PUTCreditMemoItemType). Related objects: */
...
public class PUTCreditMemoItemType extends BaseObject {
   ...
   * PUTCreditMemoItemTypeFinanceInformationItem. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: taxItems (taxItems), Type: array|PutCreditMemoTaxItemType. Options (custom, update,
