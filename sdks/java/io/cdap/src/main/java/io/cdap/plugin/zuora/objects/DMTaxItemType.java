...
/** Object name: DMTaxItemType (DMTaxItemType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "DMTaxItemType", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class DMTaxItemType extends BaseObject {
  ...
  /**
   * Name: creditAmount (creditAmount), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
