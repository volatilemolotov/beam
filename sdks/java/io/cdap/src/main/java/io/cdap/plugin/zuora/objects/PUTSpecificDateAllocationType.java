...
/** Object name: PUTSpecificDateAllocationType (PUTSpecificDateAllocationType). Related objects: */
...
public class PUTSpecificDateAllocationType extends BaseObject {
  ...
  /**
   * Name: distributeOn (distributeOn), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
  ...
  /**
   * Name: percentage (percentage), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
