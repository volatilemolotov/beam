...
/** Object name: SubscribeRequest (SubscribeRequest). Related objects: */
...
public class SubscribeRequest extends BaseObject {
  /**
   * Name: PaymentMethod (PaymentMethod), Type: SubscribeRequestPaymentMethodItem. Options (custom,
  ...
  /**
   * Name: PreviewOptions (PreviewOptions), Type: SubscribeRequestPreviewOptionsItem. Options
  ...
  /**
   * Name: SubscribeOptions (SubscribeOptions), Type: SubscribeRequestSubscribeOptionsItem. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: SubscriptionData (SubscriptionData), Type: SubscribeRequestSubscriptionDataItem. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
