...
/** Object name: DebitMemoType (DebitMemoType). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(
    Name = "DebitMemo",
    RequiredPostArguments = {"invoiceId", "body"},
...
public class DebitMemoType extends BaseObject {
  ...
  /**
   * Name: debitMemoDate (debitMemoDate), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
