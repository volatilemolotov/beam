...
/** Object name: OrderItem (OrderItem). Related objects: */
@SuppressWarnings("unused")
@ObjectDefinition(Name = "OrderItem", ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED)
public class OrderItem extends BaseObject {
  ...
  /** Name: scId (scId), Type: string. Options (custom, update, select): false, false, false */
  @Nullable
  @SerializedName("scId")
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String scId;
