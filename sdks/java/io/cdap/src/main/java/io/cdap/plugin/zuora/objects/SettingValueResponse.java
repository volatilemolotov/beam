...
/** Object name: SettingValueResponse (SettingValueResponse). Related objects: */
...
public class SettingValueResponse extends BaseObject {
  /**
   * Name: errorMessages (errorMessages), Type: array|SettingValueResponseErrorMessagesItem. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "SettingValueResponseErrorMessagesItem")
