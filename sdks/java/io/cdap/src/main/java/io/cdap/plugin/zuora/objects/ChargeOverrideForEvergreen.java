...
/** Object name: ChargeOverrideForEvergreen (ChargeOverrideForEvergreen). Related objects: */
...
public class ChargeOverrideForEvergreen extends BaseObject {
  /**
   * Name: billing (billing), Type: ChargeOverrideForEvergreenBillingItem. Options (custom, update,
  ...
  /**
   * Name: pricing (pricing), Type: ChargeOverrideForEvergreenPricingItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
