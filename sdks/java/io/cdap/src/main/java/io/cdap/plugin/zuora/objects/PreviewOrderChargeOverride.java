...
/** Object name: PreviewOrderChargeOverride (PreviewOrderChargeOverride). Related objects: */
...
public class PreviewOrderChargeOverride extends BaseObject {
  /**
   * Name: billing (billing), Type: PreviewOrderChargeOverrideBillingItem. Options (custom, update,
  ...
  /**
   * Name: pricing (pricing), Type: PreviewOrderChargeOverridePricingItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
