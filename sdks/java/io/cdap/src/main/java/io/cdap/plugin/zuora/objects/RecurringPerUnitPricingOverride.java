...
/**
 * Object name: RecurringPerUnitPricingOverride (RecurringPerUnitPricingOverride). Related objects:
 */
...
public class RecurringPerUnitPricingOverride extends BaseObject {
  /**
   * Name: listPrice (listPrice), Type: number. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
