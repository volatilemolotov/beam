...
/** Object name: CreditMemoObjectNSFields (CreditMemoObjectNSFields). Related objects: */
...
public class CreditMemoObjectNSFields extends BaseObject {
  ...
  /**
   * Name: Origin__NS (Origin__NS), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: Transaction__NS (Transaction__NS), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
