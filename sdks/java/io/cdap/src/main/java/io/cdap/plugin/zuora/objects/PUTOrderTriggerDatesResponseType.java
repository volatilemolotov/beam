...
/**
 * Object name: PUTOrderTriggerDatesResponseType (PUTOrderTriggerDatesResponseType). Related
 * objects:
 */
...
public class PUTOrderTriggerDatesResponseType extends BaseObject {
   ...
   * array|PUTOrderTriggerDatesResponseTypeSubscriptionsItem. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PUTOrderTriggerDatesResponseTypeSubscriptionsItem")
