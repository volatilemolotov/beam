...
/**
 * Object name: ProductRatePlanChargePricingTierType (ProductRatePlanChargePricingTierType). Related
 * objects:
 */
...
public class ProductRatePlanChargePricingTierType extends BaseObject {
  /**
   * Name: endingUnit (endingUnit), Type: string. Options (custom, update, select): false, false,
   * false
   */
  @Nullable
  ...
  /**
   * Name: startingUnit (startingUnit), Type: string. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
