...
/**
 * Object name: ProductRatePlanChargeTypeFinanceInformationItem
 * (ProductRatePlanChargeTypeFinanceInformationItem). Related objects:
 */
...
public class ProductRatePlanChargeTypeFinanceInformationItem extends BaseObject {
  ...
  /**
   * Name: adjustmentLiabilityAccountingCodeType (adjustmentLiabilityAccountingCodeType), Type:
  ...
  /**
   * Name: adjustmentRevenueAccountingCode (adjustmentRevenueAccountingCode), Type: string. Options
  ...
  /**
   * Name: contractAssetAccountingCode (contractAssetAccountingCode), Type: string. Options (custom,
  ...
  /**
   * Name: contractAssetAccountingCodeType (contractAssetAccountingCodeType), Type: string. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: contractLiabilityAccountingCode (contractLiabilityAccountingCode), Type: string. Options
   * (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: contractRecognizedRevenueAccountingCode (contractRecognizedRevenueAccountingCode), Type:
   * string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  /**
   * Name: contractRecognizedRevenueAccountingCodeType
   * (contractRecognizedRevenueAccountingCodeType), Type: string. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
  ...
  /**
   * Name: unbilledReceivablesAccountingCodeType (unbilledReceivablesAccountingCodeType), Type:
   * string. Options (custom, update, select): false, false, false
   */
  @Nullable
  ...
  public void addFields() {
    addCustomField(
        "adjustmentLiabilityAccountingCode", adjustmentLiabilityAccountingCode, String.class);
    addCustomField(
        "adjustmentLiabilityAccountingCodeType",
        adjustmentLiabilityAccountingCodeType,
        String.class);
    addCustomField(
        "adjustmentRevenueAccountingCode", adjustmentRevenueAccountingCode, String.class);
    addCustomField(
        "adjustmentRevenueAccountingCodeType", adjustmentRevenueAccountingCodeType, String.class);
    addCustomField("contractAssetAccountingCode", contractAssetAccountingCode, String.class);
    addCustomField(
        "contractAssetAccountingCodeType", contractAssetAccountingCodeType, String.class);
    addCustomField(
        "contractLiabilityAccountingCode", contractLiabilityAccountingCode, String.class);
    addCustomField(
        "contractLiabilityAccountingCodeType", contractLiabilityAccountingCodeType, String.class);
    addCustomField(
    ...
    addCustomField(
        "unbilledReceivablesAccountingCode", unbilledReceivablesAccountingCode, String.class);
    addCustomField(
