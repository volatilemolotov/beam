...
/**
 * Object name: PaymentDebitMemoApplicationApplyRequestType
 * (PaymentDebitMemoApplicationApplyRequestType). Related objects:
 */
...
public class PaymentDebitMemoApplicationApplyRequestType extends BaseObject {
  ...
  /**
   * Name: items (items), Type: array|PaymentDebitMemoApplicationItemApplyRequestType. Options
  ...
  @ObjectFieldDefinition(
      ...
      NestedClass = "PaymentDebitMemoApplicationItemApplyRequestType")
