...
/**
 * Object name: PreviewResultChargeMetricsItem (PreviewResultChargeMetricsItem). Related objects:
 */
...
public class PreviewResultChargeMetricsItem extends BaseObject {
  /**
   * Name: charges (charges), Type: array|ChargePreviewMetrics. Options (custom, update, select):
   * false, false, false
   */
  @Nullable
