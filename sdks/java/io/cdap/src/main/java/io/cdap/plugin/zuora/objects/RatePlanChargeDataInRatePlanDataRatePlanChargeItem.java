...
/**
 * Object name: RatePlanChargeDataInRatePlanDataRatePlanChargeItem
 * (RatePlanChargeDataInRatePlanDataRatePlanChargeItem). Related objects:
 */
...
public class RatePlanChargeDataInRatePlanDataRatePlanChargeItem extends BaseObject {
  ...
  /**
   * Name: RolloverBalance (RolloverBalance), Type: number. Options (custom, update, select): false,
   * false, false
   */
  @Nullable
