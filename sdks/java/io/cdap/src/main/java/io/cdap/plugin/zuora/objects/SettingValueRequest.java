...
/** Object name: SettingValueRequest (SettingValueRequest). Related objects: */
...
public class SettingValueRequest extends BaseObject {
  /**
   * Name: children (children), Type: array|ChildrenSettingValueRequest. Options (custom, update,
