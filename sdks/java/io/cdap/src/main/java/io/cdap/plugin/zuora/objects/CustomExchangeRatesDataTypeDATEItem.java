...
/**
 * Object name: CustomExchangeRatesDataTypeDATEItem (CustomExchangeRatesDataTypeDATEItem). Related
 * objects:
 */
...
public class CustomExchangeRatesDataTypeDATEItem extends BaseObject {
  ...
  /**
   * Name: providerExchangeRateDate (providerExchangeRateDate), Type: string. Options (custom,
