...
/** Object name: CreateOrderChargeOverride (CreateOrderChargeOverride). Related objects: */
...
public class CreateOrderChargeOverride extends BaseObject {
  /**
   * Name: billing (billing), Type: CreateOrderChargeOverrideBillingItem. Options (custom, update,
  ...
  /**
   * Name: pricing (pricing), Type: CreateOrderChargeOverridePricingItem. Options (custom, update,
   * select): false, false, false
   */
  @Nullable
