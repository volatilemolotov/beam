...
async def _get_outputs(examples: List[Example]):
  """
...
def _write_to_local_fs(example: Example):
  """
...
class CDHelper:
  ...
  def store_examples(self, examples: List[Example]):
    ...
    asyncio.run(_get_outputs(single_file_examples))
  ...
  def _save_to_cloud_storage(self, examples: List[Example]):
    ...
    for example in tqdm(examples):
      file_names = _write_to_local_fs(example)
