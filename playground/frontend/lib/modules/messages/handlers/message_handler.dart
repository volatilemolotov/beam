...
import 'package:playground/modules/messages/handlers/set_multi_content_message_handler.dart';
...
class MessageHandler extends AbstractMessageHandler {
  ...
  MessageHandler({
    ...
    SetMultiContentMessageHandler(playgroundState: playgroundState),
