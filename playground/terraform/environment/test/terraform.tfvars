...
network_name         = "my-network-name"        #GCP VPC Network Name for Playground deployment
gke_name             = "playground-backend"  #Playground GKE Cluster name
region               = "us-central1"            #Set the deployment region
location             = "us-central1-a"          #Select the deployment location from available in the specified region
