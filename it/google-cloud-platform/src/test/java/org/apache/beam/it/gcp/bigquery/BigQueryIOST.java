      ...
      TEST_CONFIGS_PRESET =
          ImmutableMap.of(
              ...
              Configuration.fromJsonString(
                  "{\"numColumns\":10,\"rowsPerSecond\":10000,\"minutes\":40,\"numRecords\":8000000,\"valueSizeBytes\":1000,\"pipelineTimeout\":60,\"runner\":\"DataflowRunner\"}",
                  Configuration.class),
              "large",
              Configuration.fromJsonString(
...
//            .addParameter("experiments", GcpOptions.STREAMING_ENGINE_EXPERIMENT + ",use_runner_v2")
            .build();
