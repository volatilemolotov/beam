 ...
 * :it:google-cloud-platform:SpannerStressTestMedium} - To run large-scale stress tests: {@code
 * gradle :it:google-cloud-platform:SpannerStressTestLarge}
 */
public final class SpannerIOST extends IOStressTestBase {
  ...
  public void runTest() throws IOException, ParseException, InterruptedException {
    ...
    //                        .build();
    //        exportMetrics(
    //                writeInfo, metricsConfig, configuration.exportMetricsToInfluxDB,
    // influxDBSettings);
    //        exportMetrics(
    //                readInfo, metricsConfig, configuration.exportMetricsToInfluxDB,
    // influxDBSettings);
  }
    ...
    public void processElement(ProcessContext c) {
      ...
      String key =
          String.format(
              "key%s",
              //                    index
              "-" + UUID.randomUUID() + "-" + UUID.randomUUID() + "-" + Instant.now().getMillis());
